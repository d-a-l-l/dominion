...
//   "submit #turn-event": turnEvent
    ...
    constructor(game, player_id) {
        ...
        this.turn = game.turn;
        this.hand = Agent.my_cards(game._id, player_id)
        // this.hand;
        // this.deck;
        // this.discard;
        // this.kingdom;
    ...
    turnEvent(selected_cards, turn_event_id) {
